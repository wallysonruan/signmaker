import { Command, PaletteNavigationState, ScopedRouterOptions, ScopeManager, FocusManagerPort } from '@signwriter/editor';
 ...
 */
export declare function useScopeManager(dispatch: (c: Command) => void, onUndo: () => void, onRedo: () => void, options?: UseScopeManagerOptions): UseScopeManagerReturn;
